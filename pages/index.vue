...
<template>
  <div class="flex flex-col justify-center items-center h-screen">
    ...
    <h1 class="text-6xl font-extrabold">
      <span class="text-[#0055A4]">A</span>
      <span class="text-white drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]"
        >C</span
      >
      <span class="text-[#EF4135]">N</span>
    </h1>

    <!-- Social network profiles. -->
    <div class="pt-2 flex space-x-4">
      <NuxtLink
        :aria-label="$t('home.profile', { name: 'GitHub' })"
        to="https://github.com/RealHinome"
        target="_blank"
      >
        <svg
      ...
      <NuxtLink
        :aria-label="$t('home.profile', { name: 'LinkedIn' })"
        to="https://www.linkedin.com/in/anthony-chenotnogues"
        target="_blank"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
